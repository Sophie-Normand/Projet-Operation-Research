include("building_random_forest.jl")
include("utilities.jl")

using ScikitLearn
using DecisionTree

function main_random_forest()
    ...
    for dataSetName in ["iris", "seeds", "wine", "thoracic_surgery", "diabetes_data"]
        ...
        for D in 2:4
            ...
            # Création de l'arbre
            print("    Univarié...  \t")
            classifier, resolution_time, gap = build_random_forest(X_train, Y_train, D, multivariate = false, time_limit = time_limit)
            ...
            ## 2 - Multivarié
            print("    Multivarié...\t")
            classifier, resolution_time, gap = build_random_forest(X_train, Y_train, D, multivariate = true, time_limit = time_limit)
